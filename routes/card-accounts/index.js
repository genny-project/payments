...
/* Deletes the card account with the specified ID */
API.delete( '/:provider/card-accounts/:id', securedRoute, async ( req, res ) => {
  ...
  /* Get the ID of the card account */
  const id = req.params.id;

  try {
    const response = await provider.deleteCardAccount( id );
